/// @description Initialize habitat defense in a friendly unit instance; the habitat assigns ownership afterward.
function habitat_unit_initialize()
{
	...
	{
		// Shared damage alerts let an idle resident and its nearby ally remember the attacker.
	...
	habitat_combat_update = function()
	{
		...
		// A quiet habitat recalls its residents only after morning has arrived.
