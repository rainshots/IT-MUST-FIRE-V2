...
var _can_restore = !_is_restore_button || cursed_point_restore_can_pay();
var _button_color = _can_restore ? (summon_button_hovered ? COLOR_PROJECTILE_SUMMON : COLOR_HUD_TEXT) : COLOR_PROJECTILE_DAMAGE;
...
if (_is_restore_button)
{
	var _restore_title = "RESTORE " + restore_structure_choice.building_name;
	var _restore_cost_text = "Cost: " + cursed_point_restore_cost_text_get();
	...
	draw_text_transformed(_button_center_x, _button_center_y + (8 * _pulse), _restore_cost_text, _pulse, _pulse, 0);
}
else
{
