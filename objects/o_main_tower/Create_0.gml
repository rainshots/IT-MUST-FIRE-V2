...
destroy_holy_tower = function()
{
	...
	// Destroying the main tower completes RAID missions, even though its ruins remain.
	if (instance_exists(o_game_controller))
	{
		var _game_controller = instance_find(o_game_controller, 0);

		if (_game_controller.mission_type == MISSION_TYPES.RAID)
		{
			_game_controller.game_completion_popup_show();
		}
	}
};
