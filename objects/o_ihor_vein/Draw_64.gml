// Draw a small Ihor Vein tooltip in GUI space.
if (!ihor_vein_is_hovered())
{
	exit;
}
...
var _tooltip_text = tooltip_text;
var _tooltip_text_height = string_height_ext(_tooltip_text, tooltip_line_height, tooltip_width - (tooltip_padding * 2));
var _tooltip_height = (tooltip_padding * 2) + _tooltip_text_height;
...
draw_text_ext(_tooltip_x + tooltip_padding, _tooltip_y + tooltip_padding, _tooltip_text, tooltip_line_height, tooltip_width - (tooltip_padding * 2));
